...
export const checkAvailabilityofCar = async (req, res) => {
    try {
        ...
        res.json({success:false, message: `Car isn't availabe ${error.message}`})
    }
}
...
export const createBooking = async (req,res) => {
    try {
        ...
        await Booking.car({car, owner: carData.owner, user: _id, pickupDate, returnDate, price});
...
export const getUserBookings = async (req,res) => {
    try {
        ...
        console.log(error.message);
        res.json({success: false, message: `Couln't fetch user booking ${error.message}`})
    }
}
...
export const changeBookingStatus = async (req,res) => {
    try {
        ...
        console.log(error.message);
        res.json({success: false, message: `Couln't change booking booking status ${error.message}`})
    }
}

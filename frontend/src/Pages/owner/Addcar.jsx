        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col w-full">
              ...
              <input
                type="text"
                placeholder="eg. BMWW, Mercedes, Audi..."
                required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col w-full">
              ...
              <select
                ...
                className="px-3 py-2 mt-1 border border-coloColor rounded-md outline-none"
              >
                ...
                <option value="MPV">MPV (Multi-Purpose Vehicles)</option>
              </select>
            </div>
          </div>
          ...
          <div className="flex flex-col w-full">
            ...
            <textarea
              rows={5}
              placeholder="eg. A luxurious SUV with a powerful engine."
              required
              className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none"

      ...
      <div className="px-4 pt-10 md:px-10 flex-1">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl">
          {dashboardCards.map((card, index) => (
            <div
              key={index}
              className="flex gap-2 items-center justify-between p-4 rounded border border-borderColor"
            >
              <div>
            ...
            {data.recentBookings.map((booking, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 font-medium">
                    <p className="text-sm text-gray-500">{import.meta.env.VITE_CURRENCY}{booking.price}</p>
        ...
        <div className="p-4 md:-6 border border-border-Color rounded-md w-full md:max-w-xs">
